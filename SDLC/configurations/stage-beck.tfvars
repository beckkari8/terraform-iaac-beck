environment = "Stage-beck" 
s3_bucket = "sdlc-beck-stage" #Will be used to set backend.tf 
...
s3_tfstate_file = "beck.tfstate" #Will be used to set backend.tf 

 public_cidr1 = "10.0.0.0/23"
  public_cidr2 = "10.0.10.0/23"
  public_cidr3 = "10.0.20.0/23"
  private_cidr1 = "10.0.100.0/23"
  private_cidr2 = "10.0.112.0/23"
  private_cidr3 = "10.0.132.0/23"
